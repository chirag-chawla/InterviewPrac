...
public class ShippingCostPart3 {
    ...
    private static final String SHIPPING_COST_FILE_PATH = "/Users/chiragchawla/Practice/InterviewPrac/src/stripePrac/ShippingCostCalculator/Part1/ShippingCost3.json";
    private static final String CA_ORDER_FILE_PATH = "/Users/chiragchawla/Practice/InterviewPrac/src/stripePrac/ShippingCostCalculator/Part1/OrderCA.json";

    public static void main(String[] args) {
        int cost = calculateShippingCost(ORDER_FILE_PATH, SHIPPING_COST_FILE_PATH);
        System.out.println(cost);
        cost = calculateShippingCost(CA_ORDER_FILE_PATH, SHIPPING_COST_FILE_PATH);
        System.out.println(cost);
    }
    ...
    private static class Cost{
        ...
        public Cost(Integer minQuantity, Integer maxQuantity, int cost, String shippingType) {
    ...
    private static int calculateCost(Order order, Map<String, List<Cost>> productCostMap){
        ...
        for(ItemOrder itemOrder : order.getItemOrders()){
            ...
            if(costs==null){
                ...
                for(Cost cost : costs){
                    if(cost.getShippingType().equals("fixed")){
                        totalCost += cost.getCost();
                    } else if(cost.getShippingType().equals("incremental")){
                        int minQ;
